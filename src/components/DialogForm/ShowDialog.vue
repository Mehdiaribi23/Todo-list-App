  ...
  >
    ...
    >
      <div class="container d-flex flex-column justify-content-between ">
        ...
        <div v-else>
          <!-- Composant d'entrée de formulaire pour le champ "Todo" -->
          <ShowDialogInput
            :label="'Todo'"
            :name="'todo'"
            :input="getInputTodo"         
          ...
          />
          <!-- Composant de sélection pour le champ "State" -->
          <ShowDialogSelect
            :label="'State'"
            :input="getInputState"
            @set-select="setInputState"
          />
          <!-- Affiche la date de création pour les éléments existants -->
...
// Retour des valeurs et des méthodes nécessaires
    return { dialog,  onCloseDialog };
  },
// Propriété requise du composant
  props: {
    dialogProps: {
      required: true,
